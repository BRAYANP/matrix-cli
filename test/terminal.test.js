                ...
                context('Parameters specified init ', function() {
                    ...
                    context('Simulator initialized', function() {
                        ...
                        context('restore', function() {
                            it('should reset the simulator', function(done) {
                                var simProc = run('matrix', ['sim', 'restore']);
                                var outputs = new Array();
                                simProc.stdout.on('data', function(out) {
                                    outputs.push(out.toString());
                        ...
                        context('start', function() {
                            it('should start MatrixOS virtual environment', function(done) {
                        ...
                        context('stop', function() {
                            it('should stop MatrixOS virtual environment', function(done) {
                        ...
                        context('save', function() {
                            it('should save MatrixOS state, use after deploy / install', function(done) {
